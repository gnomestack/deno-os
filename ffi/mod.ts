import { SystemError } from "../deps.ts";
...
export class FunctionMissingError extends SystemError {
    override readonly name = "FunctionMissingError";
    constructor(public functionName: string, message?: string) {
        super(message ?? `Function "${functionName}" not found.`);
    }
}
